...
The model was built from the curated dataset in [dataset/dataset_final (1).csv](dataset/dataset_final%20(1).csv).
...
The notebook creates and saves the main artifacts used for inference and review:

- [taglish_gec_model](taglish_gec_model) - fine-tuned model directory
- [MODEL_CARD.md](MODEL_CARD.md) - technical model card
- [QUICK_REFERENCE.md](QUICK_REFERENCE.md) - short usage guide
- [predictions.json](predictions.json) - evaluation predictions
- [predictions.csv](predictions.csv) - evaluation predictions in tabular form
- [model_evaluation.png](model_evaluation.png) - evaluation visualization
- [corrections_report.txt](corrections_report.txt) - sample correction report
